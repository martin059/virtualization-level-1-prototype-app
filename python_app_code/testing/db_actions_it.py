...
def initial_testing_console():
    ...
    dba.insert_into_task_table('1st task') # First task, only name
    dba.insert_into_task_table('2nd task', 'This is the second one') # Second task, name and description
    dba.insert_into_task_table('3rd task', 'This is the third one', task_status='Deleted') # Third task, name, description and status
    dba.insert_into_task_table('4th task', creation_date='2024-03-01') # Fourth task, name and custom creation date
    dba.insert_into_task_table('5th task', due_date='2024-03-17') # Fith task, name and due date
